...
customers_tasks = db.Table("customers_tasks",
...
class Customer(db.Model):
    ...
    availableBadges = db.Column(db.ARRAY(db.Integer))
    boughtBadges = db.Column(db.ARRAY(db.Integer))

    tasks = db.relationship("Task", secondary=customers_tasks)
    achievements = db.relationship(
        'Achievement', secondary=customers_achievements)

    def __init__(self, firstname, middlename, lastname, 
                 password, image, email, 
                 avatar, solvedTasks, activeTask,
                 achievements, activeBadge, isVip, 
                 experience, level, balance,
                 tasks, availableBadges, boughtBadges):
        ...
        self.boughtBadges = boughtBadges
